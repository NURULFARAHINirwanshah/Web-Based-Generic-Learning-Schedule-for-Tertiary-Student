...
<body>
  ...
  <h2><img src="../img/logo.png" width="85" height="85">&nbsp; &nbsp; &nbsp; Web-Based Generic Learning Schedule for Tertiary Student
		...
		<center><h1 style="margin-top:2.5%"> Sign Up </h1></center>
		
      <div align="center" class="page" >
    
        <main class="main-base" role="main">
      <form class="content" action="SignUp-func.php" method="POST">
	
		<br><br>
	  <div class="form-row">
        <input type="text" class="input-text2" name="Name" placeholder="Name" pattern="[A-Za-z\s.@]{0,}" title="letters only"/>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="submit" value="Sign Up" class="button button2">						
	</div>
