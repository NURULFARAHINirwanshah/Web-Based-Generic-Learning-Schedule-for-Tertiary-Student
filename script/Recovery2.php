...
$sql = "SELECT SecretQtn FROM student WHERE SID = '".$_SESSION["studentID"]."'";
$r = mysql_query($sql);
...
<body>
  ...
  <h2><img src="../img/logo.png" width="85" height="85">&nbsp; &nbsp; &nbsp; Web-Based Generic Learning Schedule for Tertiary Student
		...
		<center><h1> Trouble Signing In? </h1>
		<p> Can't sign in? Let's get into your account </p></center>
		<br><br><br>
   
      <div align="center" class="page" >
    
        <main class="main-base" role="main">
      <form class="content" action="Recovery2-func.php" method="POST">
		
		<center><h6><?php echo $row["SecretQtn"]; ?></h6></center>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="submit" value="Next" class="button button2">						
	</div>
