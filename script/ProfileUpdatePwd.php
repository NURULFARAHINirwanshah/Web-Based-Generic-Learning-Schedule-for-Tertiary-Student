...
<body>
  ...
  <h2><img src="../img/logo.png" width="85" height="85">&nbsp; &nbsp; &nbsp; Web-Based Generic Learning Schedule for Tertiary Student</h2>
  
	<br><br><br><center><h1> Update Password </h1></center><br><br><br>
   
  <div align="center" class="page" >
    
        <main class="main-base" role="main">
      <form class="content" action="Recovery3-func.php" method="POST">
     ...
     <div class="form-row">
        ...
        <label class="label-helper1">New Password</label>
      </div>
	  
	  <div class="form-row">
        <input type="password" class="input-text" name="CPassword" id="confirm_password" placeholder="Confirm Password" />
		<label class="label-helper">Confirm Password</label>
	  </div>
	  
	<br><br>
	 <div>
	<a href="SignIn.php"><span class="glyphicon glyphicon-circle-arrow-left white"></span><b>Back</b></a>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="submit" value="Submit" class="button button2"></div>
